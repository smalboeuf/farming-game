...
public class DialogueSequencer
{
    ...
    public void StartDialogue(Dialogue dialogue)
    {
        ...
        {
            throw new DialogueException("Error: Can't start a dialogue when another is already running.");
        }
    }
    ...
    public void EndDialogue(Dialogue dialogue)
    {
        ...
        {
            throw new DialogueException("Error: Can not stop a dialogue that is not running.");
        }
    }
    ...
    public void StartDialogueNode(DialogueNode node)
    {
        ...
        {
            throw new DialogueException("Error: Failed to start dialogue node.");
        }
    }
    ...
    private void StopDialogueNode(DialogueNode node)
    {
        ...
        {
            throw new DialogueException("Error: Trying to stop a dialogue node that isn't running.");
        }
    }
}
